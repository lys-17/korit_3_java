...
/*
        method - 순차적으로 실행되는 여러 코드들을 하나의 이름으로 묶어둔 것
                유형을 저희는 call1()~call4() 매개변수 유무 / return 유무로 분할해서 학습헀음
         ...
         호출 예시
            ...
            writeSchedule("20250321", "매서드/오버로딩/클래스/복습");
 */
...
//    }
//
//    //call2() 유형으로 작성할건데, int 숫자 하나를 매개변수로 받아가지고, 그 숫자 7의 배수인지 아닌지를 확인하는 매서드
//    void dividedBySeven(int randomNUmber) {
//        // randomNUmber를 호츨 단계에서 임의의 숫자를 받을텐데 걔가 7로 나누어지는지 확인하는 메서드를 작성하시오
//        if(randomNUmber % 7 == 0) {
...
//    }
    /*
        매개변수로 한계값을 받아서 메서드를 호출했을 때 1부터 한계값까지 출력하는 메서드를 작성
        review05. printLimitNUmber(100);
     */
    void printlnLimitNumber(int limitNum) {
       for(int i = 0; i < limitNum; i++) {
           System.out.println((i + 1) + " ");
       }
    }
    // 이상의 메서드를 참조하여 한계값을 매개변수로 받아 짝수만 축력하는 메서들르 정의하시오
    /*
        호출 방식
    ...
    public static void main(String[] args) {
        ...
        //메서드 호출 영역
//        review05.writeSchedule("20250321", "매서드/오버로딩/클래스/복습");
//        review05.writeSchedule(20250321, "매서드/오버로딩/클래스/복습");

        // 과제 매서드 호출
//        review05.dividedBySeven(45323);

        review05.printlnLimitNumber(50);
        System.out.println();
