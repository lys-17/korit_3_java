...
public class Main {
    public static void main(String[] args) {
        /*
        conversation 형변환 -> 용량 상의 문제로 일어나는 이슈를 해결하기 위해서 사용
        ...
        // 업케스팅 방법 #1
        // 형변환을 하기 위해서는 "(바꿀데이터단입)변수명"으로 작성하면 됨
        System.out.println("변형 : " + (int)cast1);          //-> 시험에 자주 나옴

        char cast2 = 'a';
        System.out.println("원형 : " + cast2);
        System.out.println("변형 : " + (int)cast2);         //-> A만큼은 아니지만
        ...
        int cast5 = 99;
        int cast6 = 100;
        // 지시사항 : 다운캐스팅하는 방법을 업캐스팅 #1, 2를 이용하여 char형으로 바꾼 후
        // 콘솔창에 원형과 변형을 모두 출력
      ...
      /*
            ...
            - upcasting 의 경우는 메모리 용량이 커지기만 하면 기존 데이터가 변형이 일어나지는
