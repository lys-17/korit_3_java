...
public class ScoreCalc {
    ...
    public static void main(String[] args) {
        ...
        // 3과목의 점수를 입력 받고, 총합과 평균 점수를 콘솔창에 출력하시오
...
//        sum += scanner.nextDouble();
//        avg = sum / numOfSubs;
//        System.out.println("총합은 " + sum + "평균은 " + avg + "점입니다");

        // 이상의 코드를 기준으로 필요한 부분을 반복적으로 바꾸는 refactoring를 작성하시오
        System.out.println("몇 과목의 점수를 입력하시겠습니까? >>>");
        numOfSubs = scanner.nextInt();
        ...
        avg = sum/numOfSubs;
        System.out.println("총합은 " + sum + "점이고, 평균은 " + avg + "점입니다");
