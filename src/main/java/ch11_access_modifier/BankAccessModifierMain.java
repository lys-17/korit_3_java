...
public class BankAccessModifierMain {
    public static void main(String[] args) {
        // 테스트용 객체 생성
//        Bank bank1 = new Bank(1234567, "안근수", 10000, 1234);
...
//        bank1.deposit(3000, pin);
        ...
        잔액이 부족하여 출금할 수 없습니다.                 # account1에서 200000원 출금 시도 실패 사례
                                                         (이십만원 출금 실패사례)
     ...
     */
        ...
        BankAccessModifier account1 = new BankAccessModifier
                (123456,"홍길동", 100000, 1234);
        BankAccessModifier account2 = new BankAccessModifier
                (987654,"신사임당", 500000, 1234);
