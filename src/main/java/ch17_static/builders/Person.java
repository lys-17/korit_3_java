...
public class Person {
   ...
   // 이상의 코드들이 코드 낭비도 심하고 실제로 쓰일지에 대한 확신도 없어서 빌더 패턴이 생겨남
    ...
    public static class Builder {
        ...
        // 대부분의 겨우 동사는 행위를 나타내기 때문에 동사로 작성되지만
        // Builder 패턴의 경우 대입될 필드의 이름과 동일한
        // 메서드 명을 짓습니다
        // 즉, Builder.neme("안근수"); 와 같은 식으로 코드 작성이 되며,
