...
public class JSON1 {
    public static void main(String[] args) {
        ...
        /*
            Map과의 차이점을 확인하면
            1. Map에서는 key 부분에 ""가 없었고, JSON에서는 모든
                key가 String 자료형처럼 보이도록 ""가 있음

            2. Map에서는 key1=value1의 형태로 작성되어있었지만
                JSON에서는 "key1":value1의 형태로 작성되어있음
         */
        jsonObject.addProperty("job", "코리아아이티강사");
        System.out.println(jsonObject);

        // 컴퓨터가 콘솔에 출력한 형태를 보니 한 줄로 죽 늘어져 있음
        // 그래서 가독성이 떨어지는 경우가 많으므로 추가적인 class를 import에서
