...
public class JSON2 {
    public static void main(String[] args) {
        ...
        //.addProperty()를 활용하여 이상에서 제공된 데이터를 입력
        ...
        // gsonBuilder를 활용하여, .toJson()을 이용, json 데이터로 변환함
        // 이상의 코드를 studentJson에 대입
        ...
        // 3. Map → json으로의 활용 사례
        /*
            Map을 활용하여 key String / value String 으로 선언하고 객체명을 map으로 한
            빈 map을 생성하시오

            map에 productCode NT968XHA - KD72G
            productName 삼성 갤럭시북 프로 5
            라는 Entry(key - value pair)를 입력하시오

            gsonBuilder를 활용하여 json으로 바꾸고 productJson에 대입
            sout(productJson)
         */

        Map<String, String> map = new HashMap<>();
        // map 에다가 entry 집어넣는 method -> .put();
        map.put("productcode", "NT968XHA - KD72G");
        ...
        // json -> jsonObject
        // 그러면 studentJson을 jsonObject2로 대입하려면 어떡하면 될까여
